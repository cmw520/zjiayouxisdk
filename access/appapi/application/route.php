...
return [
    ...
    /* 7881 */
    ':version/7881/charge/test' => 'api/:version.Game7881notify/chargeTest', /* 测试充值接口 */
    ':version/7881/queryorder/test' => 'api/:version.Game7881/queryOrderTest', /* 测试充值结果查询接口 */

    ':version/7881/charge' => 'api/:version.Game7881notify/charge', /* 充值接口 */
    ':version/7881/send' => 'api/:version.Game7881/result_push', /* 充值接口 */
    ':version/7881/queryorder' => 'api/:version.Game7881notify/queryOrder', /* 充值结果查询接口 */
    ...
    ':version/news/webdetail/:id' => 'http://120.27.212.31/float.php/Mobile/news/index/id/:id',  // 资讯详情页
    ...
    ':version/share/detail$' => 'api/:version.Share/read',  // 获取分享信息
    ':version/guestbook/write$' => 'api/:version.Guestbook/save',  // 信息反馈
    ':version/system/repair$' => 'api/:version.System/repair',  // 系统修复
    ':version/discount/index$' => 'api/:version.Discount/index',  // 折扣说明
    ...
    ':version/user/role/list$' => 'api/:version.Userrole/index',  // 获取用户角色信息
    ':version/user/money/read$' => 'api/:version.Userrole/read',  // 用户充值总金额
     ...
     */
    ':version/user/passwd/find$' => 'http://120.27.212.31/float.php/Mobile/Forgetpwd/index',  // 找回用户密码
    // ':version/user/passwd/update$' => 'http://120.27.212.31/float.php/Mobile/Forgetpwd/index',  // 找回用户密码
    ':version/user/passwd/update$' => 'http://120.27.212.31/float.php/Mobile/Password/uppwd',  // 修改密码
    ':version/user/phone/add$' => 'http://120.27.212.31/float.php/Mobile/Security/mobile',  // 密保手机
    ':version/user/email/add$' => 'http://120.27.212.31/float.php/Mobile/Security/email',  // 密保手机
    ':version/user/wallet/add$' => 'http://120.27.212.31/float.php/Mobile/Wallet/charge',  // 钱包充值
    ':version/user/wallet/add_list$' => 'http://120.27.212.31/float.php/Mobile/Wallet/charge_detail',  // 用户钱包充值记录
    ':version/user/wallet/pay_list$' => 'http://120.27.212.31/float.php/Mobile/Wallet/pay_detail',
    ':version/user/wallet/result$' => 'http://120.27.212.31/float.php/Mobile/Wallet/payresult'
];
