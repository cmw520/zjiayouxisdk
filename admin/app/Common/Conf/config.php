...
if (file_exists(SITE_PATH."conf/admin/config.php")) {
    $runtime_config = include SITE_PATH."conf/admin/config.php";
} else {
    $runtime_config = array();
}
if (file_exists(SITE_PATH."conf/admin/route.php")) {
    $routes = include SITE_PATH.'conf/admin/route.php';
} else {
    $routes = array();
}
...
$configs = array(
    ...
    'MODULE_ALLOW_LIST'            => array(
        'Admin', 'App', 'H5', 'Web', 'Float', 'Agent', 'Api', 'IosApp', 'Newapp',
        'Pay', 'Data', 'Asset', 'Sdk', 'Agentmoney', 'Tui', 'Game', 'Core', 'Content', 'Mobile', 'Wap','Device'),
    ...
    'SP_ADMIN_STYLE'               => 'flat',
    'SP_ADMIN_TMPL_PATH'           => SITE_PATH.'admin/themes/',       // 各个项目后台模板文件根目录
    ...
    'TMPL_EXCEPTION_FILE'          => SITE_PATH.'access/public/exception.html',
...
return array_merge($configs, $db, $runtime_config, $setting_config);
