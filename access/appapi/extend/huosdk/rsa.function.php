 ...
 * @param $private_key_path 商户私钥路径 return 签名结果
 */
 ...
 * @param $prestr 需要签名的字符串
 * @param $sign 签名结果
 * @param $public_key_path 公钥文件路径 return 签名结果
 */
 ...
 * @param $private_key_path 商户私钥文件路径 return 解密后内容，明文
 */
